...
// tap dance macro
#define TT ACTION_TAP_DANCE_DOUBLE
#define PRN TT(L_PRN, R_PRN)
#define CURBR TT(L_CURBR, R_CURBR)
#define BRC TT(KC_LBRC, KC_RBRC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_L1] = KEYMAP( /* LAYER 1 */
    ...
    _______, PRN     , CURBR,  BRC    , _______, _______, _______, KC_VERT, KC_BSLS, _______, _______, _______,
  ...
  [_L3] = KEYMAP( /* LAYER 3 */
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,
    KC_LCTL, _______, _______,                    KC_SPC,  _______,                   _______, _______, _______
  ),
  [_L4] = KEYMAP( /* LAYER 4 */
    KC_F1 , KC_F2   , KC_F3  , KC_F4  , KC_F5   , KC_F6 , KC_F7  , KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,
    _______,  _______, _______, _______, _______, _______, _______, _______,   _______,  _______,  _______,  _______,
    _______, _______,  _______, _______, _______, _______, _______, _______,   KC_VOLD,  KC_VOLU,  _______,  _______,
    BL_TOGG, BL_INC, BL_DEC,                      BL_BRTG,  _______,                      _______, _______, _______
  )
};
